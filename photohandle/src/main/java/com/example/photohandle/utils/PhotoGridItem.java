...
public class PhotoGridItem extends RelativeLayout implements Checkable {
	...
	public PhotoGridItem(Context context, AttributeSet attrs, int defStyle) {
		...
		mContext = context;
		LayoutInflater.from(mContext).inflate(R.layout.item_gridview_show_allphotos, this);
	...
	public void setChecked(boolean checked) {
		mCheck = checked;
		if(mCheck){
			mSelect.setBackgroundResource(R.drawable.cb_on);
		}else {
			mSelect.setBackgroundResource(R.drawable.cb_normal);
